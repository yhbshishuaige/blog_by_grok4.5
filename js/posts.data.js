...
<h2>如何体验</h2>
<ol><li>看右上角的天气徽章——固定读取<strong>江苏南京江宁区</strong>实况（Open-Meteo，不用浏览器定位）；</li><li>点天气徽章，循环预览：晴 → 阴 → 小雨 → 中雨 → 大雨 → 小雪 → 中雪 → 大雪 → 大风 → 雷电；</li><li>点天气徽章左侧的「时间」按钮，拖动轮盘预览昼夜，可随时「回到实时」；</li><li>在首页与本页之间跳转，应感觉像同一页里内容轻轻换了，而不是整页被盖住再打开；</li><li>阴天时云层应偏淡、靠上，不挡正文；雷电天气请多看几秒——会有闪电与雨粒子。</li></ol>

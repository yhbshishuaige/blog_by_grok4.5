...
<h2>你会看到什么</h2>
<p>这个博客把三件事叠在一起：</p>
<ul><li><strong>天气粒子</strong>：晴、阴、小雨、中雨、大雨、雪、大风、雷电，粒子密度与氛围色会明显变化；</li><li><strong>24 小时天空</strong>：从黎明到午夜，渐变色、柔和的太阳/月亮会随本地时间移动；</li><li><strong>路由转场</strong>：列表与文章之间只换主内容区，淡出淡入就地完成；顶栏、天空与天气动画始终在，没有强制中间页。</li></ul>
<h2>如何体验</h2>
<ol><li>看右上角的天气徽章——固定读取<strong>江苏南京江宁区</strong>实况（Open-Meteo，不用浏览器定位）；</li><li>点天气徽章，循环预览：晴 → 阴 → 小雨 → 中雨 → 大雨 → 雪 → 大风 → 雷电；</li><li>在首页与本页之间跳转，应感觉像同一页里内容轻轻换了，而不是整页被盖住再打开；</li><li>阴天时云层应偏淡、靠上，不挡正文；雷电天气请多看几秒——会有闪电与雨粒子。</li></ol>
...
<pre><code class="language-md">![千山鸟飞绝,万径人踪灭](img/a.jpg)</code></pre>`,
  }
];
